...
namespace _11_1_MaterialProperty {
    void main();
...
void _11_1_MaterialProperty::main() {
    manager.init();
    ...
    Geometry::CubeV2 obj {};
    Shader obj_shader {
        "./shaders/11-materials/material-property.vs",
        "./shaders/11-materials/material-property.fs"
    };
    obj_shader.use();
    obj_shader.set_vec3("u_color", object_color);
    obj_shader.set_vec3("u_light_color", light_color);
    obj_shader.set_vec3("u_light_position", light_source_position);
    ...
    // We've declared a struct Material in fragment shaader which help us
    // setting up the material's property
...
void _11_1_MaterialProperty::mouse_callback(GLFWwindow* window, double x, double y) {
    camera->process_cursor(x, y);
}

void _11_1_MaterialProperty::scroll_callback(GLFWwindow* window, double x_offset, double y_offset) {
    *fov -= y_offset;
