...
namespace _10_2_PhongLightingModel {
    void main();
...
void _10_2_PhongLightingModel::main() {
    manager.init();
    ...
    Geometry::CubeV2 obj {};
    Shader obj_shader {
        "./shaders/10-lighting/phong-lighting-model.vs",
        "./shaders/10-lighting/phong-lighting-model.fs"
    };
    obj_shader.use();
...
void _10_2_PhongLightingModel::mouse_callback(GLFWwindow* window, double x, double y) {
    camera->process_cursor(x, y);
}

void _10_2_PhongLightingModel::scroll_callback(GLFWwindow* window, double x_offset, double y_offset) {
    *fov -= y_offset;
